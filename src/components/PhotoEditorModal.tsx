              ...
              {textOverlays.map((item) => {
                ...
                return (
                  <div
                    ...
                    className={`absolute pointer-events-auto cursor-grab active:cursor-grabbing p-1.5 transition-shadow select-none ${fontClass} ${
                      item.bgStyle === "box"
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    ...
                    <div className="flex items-center gap-1 bg-slate-900 p-1 rounded-xl border border-slate-800">
                      <button
                        ...
                        className={`p-1.5 rounded-lg ${textAlign === "left" ? "bg-cyan-500 text-slate-950" : "text-slate-400"}`}
                      >
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg ${textAlign === "center" ? "bg-cyan-500 text-slate-950" : "text-slate-400"}`}
                      >
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg ${textAlign === "right" ? "bg-cyan-500 text-slate-950" : "text-slate-400"}`}
                      >
