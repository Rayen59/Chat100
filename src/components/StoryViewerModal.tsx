...
export const StoryViewerModal: React.FC<StoryViewerModalProps> = ({
  ...
  useEffect(() => {
    const isOverlayOpen = showComments || showViewers || showDeleteConfirm || showAnonymousInbox;

    if (!currentStory || isPaused || isHolding || isOverlayOpen) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 w-full max-w-[430px] h-[92vh] max-h-[820px] rounded-[36px] overflow-hidden bg-slate-950 border border-slate-800/80 shadow-2xl flex flex-col justify-between"
        style={{
          background:
